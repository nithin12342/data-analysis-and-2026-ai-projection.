...
*   **Software Revenue (governed by physical safety floor)**:
    *   *If* $\text{netSavings} > 0$:
        $$\frac{d(\text{softwareRevenues})}{dt} = \text{netSavings} \times \text{adoptionRate} - \text{adoptionDecayRate} \times \text{softwareRevenues}$$
    *   *If* $\text{netSavings} \le 0$ (accelerated cancellation trigger):
        ...
        $$\frac{d(\text{softwareRevenues})}{dt} = \text{netSavings} \times \text{adoptionRate} - \text{cancellationRate} \times \text{softwareRevenues}$$
    *   *Floor Constraint*:
